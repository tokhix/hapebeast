...
const Header: NextPage = () => {
    ...
    const [naviguate, setNaviguate] = useState(0)
    ...
    return (
  <nav className={`${styles.navbar} ${open ? styles.opened: ''} ${scrolling ? styles.scrolling : ''}`} >
        ...
        <div className={styles.navWrap}>
           <div className={styles.menuMobile} style={{opacity: 1, visibility: 'inherit'}}>
              <div className={styles.mobileNav}>
                 <ul className="menu">
                    <li><Link href="/jungle">Jungle</Link></li>
                    <li><Link href="/">Community</Link></li>
                    <li><Link href="/art">Art</Link></li>
                    <li><Link href="/music">Music</Link></li>
                    <li><Link href="/shop">Shop</Link></li>
                    <li><Link href="/">Dressup</Link></li>
                 </ul>
              </div>
              <div className={styles.mobileSocial}>
                 <p>Follow us on social</p>
                 <ul>
                    <li className="social-icn twitter">
                    ...
                    <li className="social-icn instagram">
                    ...
                    <li className="social-icn facebook">
           ...
           <div className={styles.menuDesktop}>
              <nav className={styles.desktopNav}>
                 <ul className="menu">
                    <li className={window.location.pathname == '/jungle'? styles.active : ''}><Link href="/jungle">Jungle</Link></li>
                    ...
                    <li className={`${styles.userImg} ${window.location.pathname == '/'? styles.imgActive : ''}`}><Link href="/"><img src='/imgs/users/0.webp' /></Link></li>
                 </ul>
              </nav>
           </div>
        </div>
